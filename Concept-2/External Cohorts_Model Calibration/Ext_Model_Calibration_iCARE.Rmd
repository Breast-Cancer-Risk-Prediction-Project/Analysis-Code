...
data_icare_lt50_val<-data_icare_lt50[,c("subject_id", "cohort", "race","case_5yinv","age","ageend","time.of.onset")]
#change names
names(data_icare_lt50_val)<-c("id","cohort","race","observed.outcome","study.entry.age","study.exit.age","time.of.onset")
data_icare_lt50_val$sampling.weights<-1

data_icare_ge50_val<-data_icare_ge50[,c("subject_id", "cohort", "race","case_5yinv","age","ageend","time.of.onset")]
#change names
names(data_icare_ge50_val)<-c("id","cohort","race","observed.outcome","study.entry.age","study.exit.age","time.of.onset")
...
```{r}
AUCageadjust<-as.data.frame(AUCcalc_ageadjust(data_icare_full))
print("AUC by age quantiles")
AUCageadjust
```
